NimModel <- nimbleCode({
  ...
  #assuming overdispersion constant over df groups. Can vary, but need to change custom ID update to reflect this.
  ...
  for(g in 1:N.session){
    ...
    #     locs[g,tel.inds[g,i],m,1]~dnorm(s[g,tel.inds[g,i],1],sd=sigma[g,G.true[g,i,2]])
    #     locs[g,tel.inds[g,i],m,2]~dnorm(s[g,tel.inds[g,i],2],sd=sigma[g,G.true[g,i,2]])
    #   }
    # }
